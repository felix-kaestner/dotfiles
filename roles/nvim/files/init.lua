...
vim.keymap.set("n", "<leader>gp", function() vim.cmd("0Git") end, { desc = "[G]it [P]ane" })
...
vim.g.netrw_keepdir = 0 -- Sync current working directory
...
require("lazy").setup({
    ...
    -- Refactoring
    {
        ...
        keys = {
            ...
            { "<leader>ri", "<cmd>lua require('refactoring').refactor('Inline Variable')<cr>", desc = "[V]ariable [I]nline" },
        },
        config = function()
