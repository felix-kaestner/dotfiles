...
complete -c k -n 'test (count (commandline -xpc)) -eq 1' -a "pod-containers" -d "Print name(s) of the container(s) within a pod"
...
complete -c k -n "__fish_seen_subcommand_from pod-containers" -f -a "(k get pod -o name | awk -F '/' '{print \$2}')"
